.. hapi_docs documentation master file, created by
   sphinx-quickstart on Fri Nov 20 11:07:19 2015.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to hapiPy3's documentation!
=====================================
...
Currently, the  [HITRANonline]_ provides the hapi.py v1.0.0 for the users. While the script is written in Python2.x and related library.
